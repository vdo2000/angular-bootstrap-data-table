...
var DataTableDemo2 = /** @class */ (function () {
    function DataTableDemo2() {
        var _this = this;
        this.carResource = new angular_4_data_table_bootstrap_4_1.DataTableResource(data_table_demo2_data_1.cars);
        this.cars = [];
        this.carCount = 0;
        this.yearLimit = 1999;
    ...
    __decorate([
        ...
        __metadata("design:type", angular_4_data_table_bootstrap_4_1.DataTable)
