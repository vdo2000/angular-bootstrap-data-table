...
var DataTableDemo3 = /** @class */ (function() {
  function DataTableDemo3() {
    var _this = this;
    this.filmResource = new angular_4_data_table_bootstrap_4_1.DataTableResource(
      data_table_demo3_data_1.films
    );
    this.films = [];
    this.filmCount = 0;
    // special params:
    ...
    this.filmResource.count().then(function(count) {
      return (_this.filmCount = count);
    });
  }
  DataTableDemo3.prototype.reloadFilms = function(params) {
    var _this = this;
    this.filmResource.query(params).then(function(films) {
