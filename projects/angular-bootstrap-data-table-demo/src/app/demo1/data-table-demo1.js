...
var DataTableDemo1 = /** @class */ (function() {
  function DataTableDemo1() {
    var _this = this;
    this.itemResource = new angular_4_data_table_bootstrap_4_1.DataTableResource(
      data_table_demo1_data_1.default
    );
    this.items = [];
    this.itemCount = 0;
  ...
  DataTableDemo1.prototype.rowTooltip = function(item) {
